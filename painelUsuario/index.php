...
<!-- COMEÇO DA SEÇÃO 1------------------------------------------------------------------------>
            ...
            <div class="menu marcador">
				<nav class="sub-menu1">
					<button onclick="window.location='../inicio.php'">
						<svg width="35" height="35" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
				...
				<nav class="sub-menu1">
					<button onclick="window.location='../painelJogo.php';">
						<svg width="35" height="35" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
				...
				<nav class="sub-menu1">
					<button onclick="window.location='../comercio.php';">
						<svg width="35" height="35" fill="currentColor" class="bi bi-shop-window" viewBox="0 0 16 16">
				...
				<nav class="sub-menu1">
					<button>
						<svg width="35" height="35" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
				...
				<nav class="sub-menu1">
					<button onclick="window.location='../painelUsuario/index.php';">
						<svg width="45" height="45" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
