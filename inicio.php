		...
		<div class="menu">
			<nav class="sub-menu1">
				<button onclick="window.location='inicio.php'">
					<svg width="35" height="35" class="bi bi-house" viewBox="0 0 16 16">
			...
			<nav class="sub-menu1">
				<button onclick="window.location='painelJogo.php';">
					<svg width="35" height="35" class="bi bi-controller" viewBox="0 0 16 16">
			...
			<nav class="sub-menu1">
				<button onclick="window.location='comercio.php';">
					<svg width="35" height="35" class="bi bi-shop-window" viewBox="0 0 16 16">
			...
			<nav class="sub-menu1">
				<button>
					<svg width="35" height="35" class="bi bi-wallet2" viewBox="0 0 16 16">
			...
			<nav class="sub-menu1">
				<button onclick="window.location='painelUsuario/index.php';">
					<svg width="35" height="35" class="bi bi-person" viewBox="0 0 16 16">
